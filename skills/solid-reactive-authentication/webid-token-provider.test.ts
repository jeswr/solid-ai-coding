...
// helpers in webid-token-provider.ts. Ported from the cross-app SECURITY-PARITY
// hardening shipped (and roborev-passed) in the pod-* apps + @jeswr/solid-session-restore,
// closing two weaknesses the reference provider had drifted behind:
//
...
//
// The two cases the lesson requires are explicitly called out:
...
describe("buildClientAuth — OMITTED method defaults per spec", () => {
